...
var Brick = (function () {
    function Brick(x, y) {
        ...
        this.sprite = 'sprite/sprite-brique.png';
        this.live = 1;
        this.points = 10;
    }
    Brick.prototype.isColliding = function (ball) {
...
var Player = (function () {
    ...
    Player.prototype.displayScore = function (selector) {
        $(selector).html(this.score);
    };
    return Player;
})();

var IndestructibleBrick = (function (_super) {
    __extends(IndestructibleBrick, _super);
    function IndestructibleBrick() {
        _super.apply(this, arguments);
        this.sprite = 'sprite/chocnoir.png';
        this.destructible = false;
    }
    return IndestructibleBrick;
})(Brick);

var ThreeLiveBrick = (function (_super) {
    __extends(ThreeLiveBrick, _super);
    function ThreeLiveBrick() {
        _super.apply(this, arguments);
        this.live = 3;
    }
    Object.defineProperty(ThreeLiveBrick.prototype, "sprite", {
        get: function () {
            if (this.live == 1) {
