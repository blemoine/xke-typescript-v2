    ...
    constructor(drawCanvas:DrawCanvas, currentLevel:number) {
        ...
        this.modelInterval = setInterval(() => {
            ...
            if (ball.speed.norm() == 0) {
                ...
                var collidingBrick = this.level.collidingBrick(ball);

                if (collidingBrick) {

                    var brickLowerCoordinate = collidingBrick.y + Brick.height;
                    ...
                    var brickRighterCoordinate = collidingBrick.x + Brick.width;
